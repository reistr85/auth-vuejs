...
const dataRegisters = 'mdi-clipboard-text-outline';
const destroy = 'mdi-delete';
const domain = 'mdi-domain';
const dotsVertical = 'mdi-dots-vertical';
